...
public class NpmLibrarySourceProvider implements LibrarySourceProvider {
    ...
    @Override
    public boolean isLibraryContentAvailable(VersionedIdentifier libraryIdentifier,
        LibraryContentType type) {
        return LibrarySourceProvider.super.isLibraryContentAvailable(libraryIdentifier, type);
    }
