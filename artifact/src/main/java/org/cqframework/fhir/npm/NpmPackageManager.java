...
public class NpmPackageManager implements IWorkerContext.ILoggingService {
    ...
    private AndroidFilesystemCacheManager pcm;
     ...
     */
    public static NpmPackageManager fromPath(Context context, String igPath, String version, String... packageServers) throws IOException {
        ...
        return new NpmPackageManager(context, (ImplementationGuide) versionConvertor_40_50.convertResource(FormatUtilities.loadFile(igPath)), version,
            packageServers);
    }

    public static NpmPackageManager fromStream(Context context,InputStream is, String version, String... packageServers) throws IOException {
        VersionConvertor_40_50 versionConvertor_40_50 = new VersionConvertor_40_50(new BaseAdvisor_40_50());
        return new NpmPackageManager(context, (ImplementationGuide) versionConvertor_40_50.convertResource(FormatUtilities.loadFile(is)), version,
            packageServers);
    }

    public static NpmPackageManager fromResource(Context context, Resource resource, String version, String... packageServers) throws IOException {
        VersionConvertor_40_50 versionConvertor_40_50 = new VersionConvertor_40_50(new BaseAdvisor_40_50());
        return new NpmPackageManager(context, (ImplementationGuide) versionConvertor_40_50.convertResource(resource), version, packageServers);
    }

    public NpmPackageManager(Context context, ImplementationGuide sourceIg, String version,
        ...
        try {
            ...
            pcm = new AndroidFilesystemCacheManager(context, this.packageServers);
        }
        catch(IOException e) {
